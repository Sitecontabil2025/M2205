    ...
    <div class="container pt-10 text-align-justify overflow-hidden">
        <?php if(array_key_exists("error", $json)): ?>
            ...
            <?php else: ?>
                ...
                <h1 class="titulos-paginas h2"><?= $titulo_pagina; ?></h1>
            ...
            <a href="noticias.php?p=<?= $p ?>&regiao=<?= $regiao_url ?>" class="bt bt-b2"><i class="fas mr-1 fa-inbox"></i> Voltar para a listagem de notícias</a>
        <?php endif; ?>
    </div>
